...
<Steps>
  ...
  <Step title="Install dependencies">
    ...
    - All other required packages from package.json:package.json
  </Step>
...
- **No implicit returns** (tsconfig.json:9)
- **Isolated modules** (tsconfig.json:12)
- **ES2022** target (tsconfig.json:15)
